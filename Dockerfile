...
# Installs PHP 7.1
RUN apt-get install php7.1 php7.1-cli php7.1-fpm php7.1-mysql php7.1-xml php7.1-mcrypt php7.1-curl php7.1-dev php7.1-mbstring php7.1-redis php7.1-zip php-imagick -y
